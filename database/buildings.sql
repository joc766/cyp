/* NOT DONE, STILL TRYING TO FIGURE THIS OUT */
...
/* I left out some of the fields that were repetitive (ex. address and historical alias) */
SELECT * from OPENJSON(@json, '$.ServiceResponse.Buildings')
with (
    id int '$.ID',
    name nvarchar(max) '$.DESCRIPTION',
    /* 50 char max for now, but can change later */
    site nvarchar(50) '$.SITE',
    /* 4 byte for float right now, can change later if needed */
    long float(24) '$.LONGITUDE',
    lat float(24) '$.LATITUDE',
    hist_name nvarchar(MAX) '$.HISTORICAL_NAME',
    abbr nvarchar(10) '$.BUILDING_ABBR', 
    usage nvarchar(50) '$.USAGE_DESCRIPTION',
    zipcode nvarchar(6) '$.ADDRESS_3',
    stat nvarchar(20) '$.STATUS',
    num nvarchar(10) '$.BUILDING',
    info nvarchar(max) '$.BUILDING_PROSE',
    street nvarchar(50) '$.ADDR1_ALIAS',
    city nvarchar(50) '$.ADDRESS_2',
    rating int '$.TOTAL_RATING',
    num_ratings int '$.NUMBER_RATINGS'
);